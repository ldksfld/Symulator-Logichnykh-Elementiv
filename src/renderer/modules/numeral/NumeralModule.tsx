...
export default function NumeralModule() {
  ...
  useEffect(() => { setActiveModule('/numeral') }, [setActiveModule])
    ...
    <div className="flex h-full overflow-hidden">
      <div className="flex-1 flex flex-col overflow-hidden p-4 gap-4 min-w-0">
          ...
          <div className="flex gap-3 flex-wrap">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (b === outputBase) {
                    ...
                    if (other) setOutputBase(other.value)
                  }
                  setInputBase(b)
                }}
            ...
            <div className="w-40">
              ...
              <input
                ...
                onChange={(e) => setFractionDigits(Math.max(1, Math.min(32, parseInt(e.target.value) || 8)))}
        ...
        {(inputBase === 16 || outputBase === 16) && (
          <HexPowersTable usedInConversion={[]} />
        )}
      </div>
